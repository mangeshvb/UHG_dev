...
<Profile xmlns="http://soap.sforce.com/2006/04/metadata">
    <applicationVisibilities>
        <application>Hospital_Management_System</application>
    ...
    <fieldPermissions>
        <editable>true</editable>
        <field>Appointment__c.Fees__c</field>
        <readable>true</readable>
    </fieldPermissions>
    <fieldPermissions>
        <editable>true</editable>
        <field>Appointment__c.prescriptions__c</field>
        <readable>true</readable>
    </fieldPermissions>
    <fieldPermissions>
    ...
    <layoutAssignments>
        <layout>Doctor__c-Permanent Doc</layout>
    </layoutAssignments>
    <layoutAssignments>
        <layout>Doctor__c-Permanent Doc</layout>
        <recordType>Doctor__c.Permanent_Doc</recordType>
    </layoutAssignments>
    <layoutAssignments>
        <layout>Doctor__c-Temprory Doc</layout>
        <recordType>Doctor__c.Temprory_doc</recordType>
    </layoutAssignments>
    <layoutAssignments>
